...
export default function UserClassesPage() {
  const { primaryRole } = useAuth(); // 获取 primaryRole (trainer, member, admin)
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {loading ? (
            ...
            <div key={cls.id} className="p-6 border border-slate-100 rounded-3xl bg-slate-50 group hover:bg-white hover:border-slate-300 transition-all relative">
              ...
              {/* <span className="text-[10px] font-bold uppercase text-indigo-600 bg-indigo-50 px-2 py-1 rounded-lg">
                {cls.class_type || "General"}
              </span> */}
