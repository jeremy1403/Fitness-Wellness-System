...
Default demo accounts created by `DefaultUserSeeder`:

| Name | Email | Role | Status | Password |
|------|-------|------|--------|----------|
| System Admin | `admin@fitness.test` | admin | active | `password` |
| Default Trainer | `trainer@fitness.test` | trainer | active | `password` |
| Default Member | `member@fitness.test` | member | active | `password` |
| Disabled Member | `disabled@fitness.test` | member | disabled | `password` |
